...
<div>
    <x-modals.modal modalId="new-withdrawal-modal">

        <form method="POST" action="{{ route('transactions.withdrawal', $account) }}">
            @csrf

            <x-modals.modal-header modalId="new-deposit-modal" modalTitle="New Withdrawal" />
