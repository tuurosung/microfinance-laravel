<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark" data-color-theme="Blue_Theme" class="light selected"
...
<body class="min-h-screen bg-info/5 dark:bg-zinc-800" class="DEFAULT_THEME bg-white dark:bg-dark">
    <flux:sidebar sticky collapsible="mobile"
        ...
        <flux:sidebar.nav>
            <flux:sidebar.group :heading="__('Platform')" class="grid">
                ...
                <!-- KYC Compliance -->
                <flux:sidebar.group expandable heading="KYC Compliance" icon="key">

                    <flux:sidebar.item href="#">Verified KYCs</flux:sidebar.item>
                    <flux:sidebar.item href="#">Pending Verfication</flux:sidebar.item>
